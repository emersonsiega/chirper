let users = {
    ...
    emersonsiega: {
        id: 'emersonsiega',
        name: 'Emerson Siega',
        avatarURL: 'https://pbs.twimg.com/profile_images/869380640654884864/mZMor6C6_400x400.jpg',
        tweets: ['5c9qojr2d1738zlx09afby', 'f4xzgapq7mu783k9t02ghx', 'nnvkjqoevs8t02lzcc0ky', '4pt0px8l0l9g6y69ylivti', 'fap8sdxppna8oabnxljzcv', 'leqp4lzfox7cqvsgdj0e7', '26p5pskqi88i58qmza2gid', 'xi3ca2jcfvpa0i3t4m7ag']
    },
}
...
let tweets = {
    ...
    "6h5ims9iks66d4m7kqizmv": {
        ...
        likes: ['dan_abramov', 'emersonsiega'],
...
const _getUsers = () => new Promise((res, rej) => setTimeout(() => res({ ...users }), 1000))

const _getTweets = () => new Promise((res, rej) => setTimeout(() => res({ ...tweets }), 1000))

const _saveLikeToggle = ({ id, hasLiked, authedUser }) =>
    new Promise((res, rej) =>
        setTimeout(() => {
            tweets = {
                ...tweets,
...
const _saveTweet = ({ text, author, replyingTo }) =>
    new Promise((res, rej) => {
